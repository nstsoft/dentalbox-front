...
class T46 extends Component {
    ...
    changeColor = ( event ) => {
        ...
        this.props.setTeethChart( teeth, '46' )

    };

    render () {

        if( R.path(['tooth', '46','implant'], this.props) ){return <img   src={implant} />}
        if( R.path(['tooth', '46','crown'], this.props)){return <img  src={crown} />}
        if( R.path(['tooth', '46','removed'], this.props)){return <img  src={removed} />}

        let style_1 = {
            'fill': R.path( ['tooth', '46', '46-1', 'color'], this.props ) || 'none',
            'stroke': '#000000',
        ...
        let style_2 = {
            'fill': R.path( ['tooth', '46', '46-2', 'color'], this.props ) || 'none',
            'stroke': '#000000',
            'strokeWidth': '0.26458332px',
            'strokeLinecap': 'butt',
            'strokeLinejoin': 'miter',
        ...
        let style_3 = {
            'fill': R.path( ['tooth', '46', '46-3', 'color'], this.props ) || 'none',
            'stroke': '#000000',
            'strokeWidth': '0.26458332px',
            'strokeLinecap': 'butt',
            'strokeLinejoin': 'miter',
        ...
        let style_4 = {
            'fill': R.path( ['tooth', '46', '46-4', 'color'], this.props ) || 'none',
            'stroke': '#000000',
            'strokeWidth': '0.26458332px',
            'strokeLinecap': 'butt',
            'strokeLinejoin': 'miter',
...
export default connect( mapStateToProps, mapDispatchToProps )( T46 );
