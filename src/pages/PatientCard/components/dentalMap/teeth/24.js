...
class T24 extends Component {
    ...
    changeColor = (event) => {
        ...
        this.props.setTeethChart( teeth, '24' )

    };

    render() {

        if( R.path(['tooth', '24','implant'], this.props) ){
            return <img className="rotated" src={implant} />
        }
        if( R.path(['tooth', '24','crown'], this.props)){
            return <img className="rotated" src={crown} />
        }

        if( R.path(['tooth', '24','removed'], this.props)){
            return <img className="rotated" src={removed} />
        }

        let style_1 = {

            "fill":  R.path( ['tooth', '24','24-1','color'],this.props  )|| 'none',
            "stroke": "#000000",
        ...
        let style_2 = {
            ...
            "fill":  R.path( ['tooth', '24','24-2','color'],this.props  )|| 'none',
            "stroke": "#000000",
            "strokeWidth": "0.26458332px",
            "strokeLinecap": "butt",
            "strokeLinejoin": "miter",
...
export default connect( mapStateToProps, mapDispatchToProps )( T24 );
