...
class T38 extends Component {
    ...
    changeColor = ( event ) => {
        ...
        this.props.setTeethChart ( teeth, '38' );

    };

    render () {

        if( R.path(['tooth', '38','implant'], this.props) ){return <img  src={implant} />}
        if( R.path(['tooth', '38','crown'], this.props)){return <img  src={crown} />}
        if( R.path(['tooth', '38','removed'], this.props)){return <img  src={removed} />}

        let style_1 = {
            'fill':           R.path ( [ 'tooth', '38', '38-1', 'color' ], this.props ) || 'none',
            'stroke':         '#000000',
        ...
        let style_2 = {
            'fill':           R.path ( [ 'tooth', '38', '38-2', 'color' ], this.props ) || 'none',
            'stroke':         '#000000',
            'strokeWidth':    '0.26458332px',
            'strokeLinecap':  'butt',
            'strokeLinejoin': 'miter',
        ...
        let style_3 = {
            'fill':           R.path ( [ 'tooth', '38', '38-3', 'color' ], this.props ) || 'none',
            'stroke':         '#000000',
            'strokeWidth':    '0.26458332px',
            'strokeLinecap':  'butt',
            'strokeLinejoin': 'miter',
        ...
        let style_4 = {
            'fill':           R.path ( [ 'tooth', '38', '38-4', 'color' ], this.props ) || 'none',
            'stroke':         '#000000',
            'strokeWidth':    '0.26458332px',
            'strokeLinecap':  'butt',
            'strokeLinejoin': 'miter',
        ...
        return (
            ...
            >
                <g>
                    <g>
                        <g
                            transform="matrix(1,0,0,-1,-2.7258342,299.79307)"
                        >
                            <image
                                y="-23.331198"
                                x="4.388947"
...
export default connect ( mapStateToProps, mapDispatchToProps ) ( T38 );