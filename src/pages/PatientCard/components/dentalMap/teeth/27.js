...
class T27 extends Component {
    ...
    changeColor = ( event ) => {
        ...
        this.props.setTeethChart( teeth, '27' )

    };

    render () {

        if( R.path(['tooth', '27','implant'], this.props) ){return <img className="rotated" src={implant} />}
        if( R.path(['tooth', '27','crown'], this.props)){return <img className="rotated" src={crown} />}
        if( R.path(['tooth', '27','removed'], this.props)){return <img className="rotated" src={removed} />}

        let style_1 = {
            'fill':  R.path( ['tooth', '27','27-1','color'],this.props  )|| 'none',
            'stroke': '#000000',
        ...
        let style_2 = {
            'fill':  R.path( ['tooth', '27','27-2','color'],this.props  )|| 'none',
            'stroke': '#000000',
            'strokeWidth': '0.26458332px',
            'strokeLinecap': 'butt',
            'strokeLinejoin': 'miter',
        ...
        let style_3 = {
            'fill': R.path( ['tooth', '27','27-3','color'],this.props  )|| 'none',
            'stroke': '#000000',
            'strokeWidth': '0.26458332px',
            'strokeLinecap': 'butt',
            'strokeLinejoin': 'miter',
        ...
        let style_4 = {
            'fill': R.path( ['tooth', '27','27-4','color'],this.props  )|| 'none',
            'stroke': '#000000',
            'strokeWidth': '0.26458332px',
            'strokeLinecap': 'butt',
            'strokeLinejoin': 'miter',
...
export default connect( mapStateToProps, mapDispatchToProps )( T27 );