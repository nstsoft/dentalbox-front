...
class T34 extends Component {
    ...
    changeColor = ( event ) => {
        ...
        this.props.setTeethChart ( teeth, '34' );

    };

    render () {

        if( R.path(['tooth', '34','implant'], this.props) ){return <img   src={implant} />}
        if( R.path(['tooth', '34','crown'], this.props)){return <img  src={crown} />}
        if( R.path(['tooth', '34','removed'], this.props)){return <img   src={removed} />}

        let style_1 = {

            'fill':           R.path ( [ 'tooth', '34', '34-1', 'color' ], this.props ) || 'none',
            'stroke':         '#000000',
        ...
        let style_2 = {
            ...
            'fill':           R.path ( [ 'tooth', '34', '34-2', 'color' ], this.props ) || 'none',
            'stroke':         '#000000',
            'strokeWidth':    '0.26458332px',
            'strokeLinecap':  'butt',
            'strokeLinejoin': 'miter',
...
export default connect ( mapStateToProps, mapDispatchToProps ) ( T34 );
