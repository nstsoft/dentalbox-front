...
class T45 extends Component {
    ...
    changeColor = ( event ) => {
        ...
        this.props.setTeethChart( teeth, '45' )

    };

    render () {

        if( R.path(['tooth', '45','implant'], this.props) ){return <img src={implant} />}
        if( R.path(['tooth', '45','crown'], this.props)){return <img   src={crown} />}
        if( R.path(['tooth', '45','removed'], this.props)){return <img   src={removed} />}

        let style_1 = {
            'fill': R.path( ['tooth', '45', '45-1', 'color'], this.props ) || 'none',
            'stroke': '#000000',
        ...
        let style_2 = {
            'fill': R.path( ['tooth', '45', '45-2', 'color'], this.props ) || 'none',
            'stroke': '#000000',
            'strokeWidth': '0.26458332px',
            'strokeLinecap': 'butt',
            'strokeLinejoin': 'miter',
...
export default connect( mapStateToProps, mapDispatchToProps )( T45 );
