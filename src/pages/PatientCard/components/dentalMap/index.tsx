    ...
    <Grid2 className="dental-map">
      ...
      <ToothMapLayout>
        <ToothBox orientation="top" toothNumber={21}>
          <T21Svg tooth={mergedChart.t21} onColorChange={on4ZoneColorChange} />
          <Zone4Segment
            toothKey="t21"
        ...
        <ToothBox orientation="top" toothNumber={22}>
          <T22Svg tooth={mergedChart.t22} onColorChange={on4ZoneColorChange} />
          <Zone4Segment
            toothKey="t22"
        ...
        <ToothBox orientation="top" toothNumber={23}>
          <T23Svg tooth={mergedChart.t23} onColorChange={on4ZoneColorChange} />
          <Zone4Segment
            toothKey="t23"
        ...
        <ToothBox orientation="top" toothNumber={24}>
          <T24Svg tooth={mergedChart.t24} onColorChange={on4ZoneColorChange} />
          <Zone4Segment
            toothKey="t24"
        ...
        <ToothBox orientation="top" toothNumber={25}>
          <T25Svg tooth={mergedChart.t25} onColorChange={on4ZoneColorChange} />
          <Zone4Segment
            toothKey="t25"
        ...
        <ToothBox orientation="top" toothNumber={26}>
          <T26Svg tooth={mergedChart.t26} onColorChange={on5ZoneColorChange} />
          <Zone5Segment
            toothKey="t26"
        ...
        <ToothBox orientation="top" toothNumber={27}>
          <T27Svg tooth={mergedChart.t27} onColorChange={on5ZoneColorChange} />
          <Zone5Segment
            toothKey="t27"
        ...
        <ToothBox orientation="top" toothNumber={28}>
          <T28Svg tooth={mergedChart.t28} onColorChange={on5ZoneColorChange} />
          <Zone5Segment
            toothKey="t28"
      ...
      <ToothMapLayout>
        <ToothBox orientation="bottom" toothNumber={48}>
          <Zone5Segment
            ...
            onZoneTrigger={on5ZoneTrigger}
          />
          <T48Svg tooth={mergedChart.t48} onColorChange={on5ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={47}>
          <Zone5Segment
            ...
            onZoneTrigger={on5ZoneTrigger}
          />
          <T47Svg tooth={mergedChart.t47} onColorChange={on5ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={46}>
          <Zone5Segment
            ...
            onZoneTrigger={on5ZoneTrigger}
          />
          <T46Svg tooth={mergedChart.t46} onColorChange={on5ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={45}>
          <Zone4Segment
            ...
            onZoneTrigger={on4ZoneTrigger}
          />
          <T45Svg tooth={mergedChart.t45} onColorChange={on4ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={44}>
          <Zone4Segment
            ...
            onZoneTrigger={on4ZoneTrigger}
          />
          <T44Svg tooth={mergedChart.t44} onColorChange={on4ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={43}>
          <Zone4Segment
            ...
            onZoneTrigger={on4ZoneTrigger}
          />
          <T43Svg tooth={mergedChart.t43} onColorChange={on4ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={42}>
          <Zone4Segment
            ...
            onZoneTrigger={on4ZoneTrigger}
          />
          <T42Svg tooth={mergedChart.t42} onColorChange={on4ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={41}>
          <Zone4Segment
            ...
            onZoneTrigger={on4ZoneTrigger}
          />
          <T41Svg tooth={mergedChart.t41} onColorChange={on4ZoneColorChange} />
        </ToothBox>
      </ToothMapLayout>
      <Divider orientation="vertical" />
      <ToothMapLayout>
        <ToothBox orientation="bottom" toothNumber={31}>
          <Zone4Segment
            ...
            onZoneTrigger={on4ZoneTrigger}
          />
          <T31Svg tooth={mergedChart.t31} onColorChange={on4ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={32}>
          <Zone4Segment
            ...
            onZoneTrigger={on4ZoneTrigger}
          />
          <T32Svg tooth={mergedChart.t32} onColorChange={on4ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={33}>
          <Zone4Segment
            ...
            onZoneTrigger={on4ZoneTrigger}
          />
          <T33Svg tooth={mergedChart.t33} onColorChange={on4ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={34}>
          <Zone4Segment
            ...
            onZoneTrigger={on4ZoneTrigger}
          />
          <T34Svg tooth={mergedChart.t34} onColorChange={on4ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={35}>
          <Zone4Segment
            ...
            onZoneTrigger={on4ZoneTrigger}
          />
          <T35Svg tooth={mergedChart.t35} onColorChange={on4ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={36}>
          <Zone5Segment
            ...
            onZoneTrigger={on5ZoneTrigger}
          />
          <T36Svg tooth={mergedChart.t36} onColorChange={on5ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={37}>
          <Zone5Segment
            ...
            onZoneTrigger={on5ZoneTrigger}
          />
          <T37Svg tooth={mergedChart.t37} onColorChange={on5ZoneColorChange} />
        </ToothBox>
        <ToothBox orientation="bottom" toothNumber={38}>
          <Zone5Segment
            ...
            onZoneTrigger={on5ZoneTrigger}
          />
          <T38Svg tooth={mergedChart.t38} onColorChange={on5ZoneColorChange} />
        </ToothBox>
      </ToothMapLayout>
    </Grid2>
  );
