...
export const T32Svg: FC<TeethMapProps> = ({ tooth, onColorChange }) => {
  ...
  return (
    <SvgIcon className="tooth-svg r b 2">
      <svg width="17.6" height="60.8" version="1.1" viewBox="0 0 17.6 60.8">
        <T32_IMAGE />
        <path
          style={style_2}
          onClick={() => onColorChange("t32", "c2")}
